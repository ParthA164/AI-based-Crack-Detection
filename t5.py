...
def preprocess_image(image_path):
    ...
    brightened = cv2.add(gray, 10)  # Brighten image
    enhanced = cv2.convertScaleAbs(brightened, alpha=1.5, beta=0)  # Increase contrast
...
# ---- USAGE ----
image_path = "D:/Desktop/Cap1/sample8.jpg"  # Replace with your image path
original_image, processed_image = preprocess_image(image_path)
edges = detect_cracks(processed_image)
segmented_image = segment_crack(edges)
